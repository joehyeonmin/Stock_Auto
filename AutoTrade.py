...
def dbgout(message):
    ...
    post_message(myToken, "#autostock", strbuf)
...
if __name__ == '__main__':
    try:
        # 자동매매할 종목 리스트
        # 미래에셋증권 삼성중공업 메리츠증권 한화생명 대우건설
        # SK증권 한화투자증권 주연테크 SG세계물산 이엔플러스
        symbol_list = ['A006800', 'A010140', 'A008560', 'A088350', 'A047040',
                       'A001510', 'A003530', 'A044380', 'A004060', 'A074610']

        bought_list = []     # 매수 완료된 종목 리스트
        target_buy_count = 5  # 매수할 종목 수
        buy_percent = 0.19  # 가용금액 퍼센트
